...
def get_embedding(text):
    ...
    # Troncature pour Titan V2 (max 8192 tokens)
    # Dans les textes juridiques ou chiffres, 1 token ~ 1 caractère.
    # On met une limite de sécurité brute et absolue à 8000 caractères.
    if len(text) > 8000:
        text = text[:8000]
