# Gabarits de livrables — Assistant Copro Delacour Patrimoine
...
## note_interne (note interne structurée — gestionnaire Delacour Patrimoine)
...
```
[En-tête : logo `logo Delacour.png` (fichier du projet) + coordonnées du syndic Delacour Patrimoine]
...
```
[En-tête : logo `logo Delacour.png` (fichier du projet)]
...
[Gestionnaire — Delacour Patrimoine]
```
