---
name: dlc-note-juridique
description: >-
  Produit une analyse juridique structurée pour un gestionnaire de copropriété
  Delacour Patrimoine : interprétation du règlement de copropriété (RCP), validité ou portée d'une
...
# Analyse juridique copropriété — Assistant Copro Delacour Patrimoine

## Garde-fous (non contournables)
- **Périmètre copro fixé** (immatriculation RNIC) avant toute analyse.
...
Ce skill produit la **substance** juridique (l'analyse). Si l'utilisateur veut en faire un **livrable** (note formelle, courrier au conseil syndical), enchaîne avec le skill `dlc-redaction-livrable` pour la mise en forme — **sans jamais durcir** une conclusion juridique au passage (les réserves restent).
